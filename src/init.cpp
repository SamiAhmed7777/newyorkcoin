...
void Shutdown()
{
    ...
    RenameThread("newyorkcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // NewYorkCoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/newyorkcoin/newyorkcoin>";
    const std::string URL_WEBSITE = "<https://newyorkcoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("newyorkcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("NewYorkCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // NewYorkCoin: Do we need to do any RPC mining init here?
